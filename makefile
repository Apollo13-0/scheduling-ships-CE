...
SRCS = main.c ship.c CEthreads.c config-file/config.c server.c tests/server_test.c tests/ship_test.c tests/thread_test.c tests/mutex_test.c tests/config_test.c canal.c tests/canal_test.c  linkedList.c tests/schedulers_test.c ocean.c schedulers.c
